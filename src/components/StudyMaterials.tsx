...
const StudyMaterials = () => {
  const driveLink =
    "https://drive.google.com/drive/folders/1aCjXkJd8czDgnR75Fx6yUlNfuAnwbJO1?usp=sharing";
  ...
  return (
    <section id="study-materials" className="relative py-24 px-4 overflow-hidden">
      ...
      {/* === Transparent overlay just for dark tint === */}
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div ref={card1Ref} className={`scroll-slide-left ${card1Visible ? "visible" : ""}`}>
            <Card className="glass-premium p-8 card-glow h-full relative z-10">
        ...
        <div
          ...
          className="scroll-fade-up mt-8 max-w-3xl mx-auto relative z-10"
        >
